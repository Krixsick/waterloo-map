...
export default function TransitPanel({ tab, onExplore, onPlan, onClose, children }: { tab: "explore" | "plan"; onExplore: () => void; onPlan: () => void; onClose: () => void; children: ReactNode }) {
  return <section aria-label="Transit" className="absolute left-3 right-3 top-20 z-30 max-h-[calc(100svh-6rem)] overflow-y-auto rounded-2xl border border-slate-200 bg-white p-3 shadow-md sm:left-5 sm:right-auto sm:w-[25rem]">
